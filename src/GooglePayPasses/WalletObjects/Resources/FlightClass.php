...
use GooglePayPasses\WalletObjects\Collections\FlightClassListResponse;
use GooglePayPasses\WalletObjects\Models\AddMessageRequest;
use GooglePayPasses\WalletObjects\Models\FlightClassAddMessageResponse;
use GooglePayPasses\WalletObjects\Collections\FlightClass as FlightClassCollection;
...
class FlightClass extends Resource
{
    ...
    public function addmessage(string $resourceId, AddMessageRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('addmessage', array($params), FlightClassAddMessageResponse::class);
    }
    ...
    public function get(string $resourceId, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), FlightClassCollection::class);
    }
     ...
     * (flightclass.insert)
     *
     * @param FlightClassCollection $postBody
     * @param array $optParams Optional parameters.
     * @return FlightClassCollection
     * @throws Exception
     */
    public function insert(FlightClassCollection $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('insert', array($params), FlightClassCollection::class);
    }
    ...
    public function listFlightclass($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), FlightClassListResponse::class);
    }
     ...
     * @throws Exception
     */
    public function patch(string $resourceId, FlightClassCollection $postBody, $optParams = array())
    {
        $params = array('resourceId' => $resourceId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('patch', array($params), FlightClassCollection::class);
    }
     ...
     * @throws Exception
     */
    public function update(string $resourceId, FlightClassCollection $postBody, $optParams = array())
    {
        $params = array('resourceId' => $resourceId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), FlightClassCollection::class);
    }
}