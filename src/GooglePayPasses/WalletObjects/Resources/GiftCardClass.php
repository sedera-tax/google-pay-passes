...
use GooglePayPasses\WalletObjects\Collections\GiftCardClassListResponse;
use GooglePayPasses\WalletObjects\Models\AddMessageRequest;
use GooglePayPasses\WalletObjects\Models\GiftCardClassAddMessageResponse;
use GooglePayPasses\WalletObjects\Collections\GiftCardClass as GiftCardClassCollection;

class GiftCardClass extends Resource
{
    /**
    ...
    public function addmessage(string $resourceId, AddMessageRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('addmessage', array($params), GiftCardClassAddMessageResponse::class);
    }
     ...
     * characters, '.', '_', or '-'.
     * @param array $optParams Optional parameters.
     * @return GiftCardClassCollection
     * @throws Exception
     */
    public function get(string $resourceId, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), GiftCardClassCollection::class);
    }
     ...
     *
     * @param GiftCardClassCollection $postBody
     * @param array $optParams Optional parameters.
     * @return GiftCardClassCollection
     * @throws Exception
     */
    public function insert(GiftCardClassCollection $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('insert', array($params), GiftCardClassCollection::class);
    }
    ...
    public function listGiftcardclass($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), GiftCardClassListResponse::class);
    }
     ...
     * @throws Exception
     */
    public function patch(string $resourceId, GiftCardClassCollection $postBody, $optParams = array())
    {
        $params = array('resourceId' => $resourceId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('patch', array($params), GiftCardClassCollection::class);
    }
     ...
     * @throws Exception
     */
    public function update(string $resourceId, GiftCardClassCollection $postBody, $optParams = array())
    {
        $params = array('resourceId' => $resourceId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), GiftCardClassCollection::class);
    }
}