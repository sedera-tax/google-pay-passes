...
use GooglePayPasses\WalletObjects\Collections\InfoModuleData;
use GooglePayPasses\WalletObjects\Collections\LabelValueRow;
use GooglePayPasses\WalletObjects\Collections\LinksModuleData;
...
use GooglePayPasses\WalletObjects\Models\FlightCarrier;
...
use GooglePayPasses\WalletObjects\Models\ImageUri;
...
use GooglePayPasses\WalletObjects\Models\LoyaltyPointsBalance;
...
class ResourceDefinitions
{
     ...
     *
     *******************************/
    public static function makeOfferClassResource(string $classId) : OfferClass
    {
     ...
     *
     *******************************/
    public static function makeOfferObjectResource(string $classId, string $objectId) : OfferObject
    {
     ...
     *
     *******************************/
    public static function makeEventTicketClassResource(string $classId) : EventTicketClass
    {
        // Define the resource representation of the Class
        // values should be from your DB/services; here we hardcode information
     ...
     *
     *******************************/
    public static function makeEventTicketObjectResource(string $classId, string $objectId) : EventTicketObject
    {
        // Define the resource representation of the Object
        // values should be from your DB/services; here we hardcode information
     ...
     *
     *******************************/
    public static function makeFlightClassResource(string $classId) : FlightClass
    {
        // Define the resource representation of the Class
        // values should be from your DB/services; here we hardcode information
     ...
     *
     *******************************/
    public static function makeFlightObjectResource(string $classId, string $objectId) : FlightObject
    {
        // Define the resource representation of the Object
        // values should be from your DB/services; here we hardcode information
     ...
     *
     *******************************/
    public static function makeGiftCardClassResource(string $classId) : GiftCardClass
    {
        // Define the resource representation of the Class
        // values should be from your DB/services; here we hardcode information
     ...
     *
     *******************************/
    public static function makeGiftCardObjectResource(string $classId, string $objectId) : GiftCardObject
    {
        // Define the resource representation of the Object
        // values should be from your DB/services; here we hardcode information
     ...
     *
     *******************************/
    public static function makeTransitClassResource(string $classId) : TransitClass
    {
        // Define the resource representation of the Class
        // values should be from your DB/services; here we hardcode information
     ...
     *
     *******************************/
    public static function makeTransitObjectResource(string $classId, string $objectId) : TransitObject
    {
        // Define the resource representation of the Object
        // values should be from your DB/services; here we hardcode information
