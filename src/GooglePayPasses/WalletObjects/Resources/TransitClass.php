...
use GooglePayPasses\WalletObjects\Collections\TransitClassListResponse;
use GooglePayPasses\WalletObjects\Models\AddMessageRequest;
use GooglePayPasses\WalletObjects\Collections\TransitClass as TransitClassCollection;
use GooglePayPasses\WalletObjects\Models\TransitClassAddMessageResponse;

class TransitClass extends Resource
{
    /**
    ...
    public function addmessage(string $resourceId, AddMessageRequest $postBody, $optParams = array())
    {
        ...
        return $this->call('addmessage', array($params), TransitClassAddMessageResponse::class);
    }
    ...
    public function get(string $resourceId, $optParams = array())
    {
        ...
        $params = array_merge($params, $optParams);
        return $this->call('get', array($params), TransitClassCollection::class);
    }
     ...
     * (transitclass.insert)
     *
     * @param TransitClassCollection $postBody
     * @param array $optParams Optional parameters.
     * @return TransitClassCollection
     * @throws Exception
     */
    public function insert(TransitClassCollection $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('insert', array($params), TransitClassCollection::class);
    }
    ...
    public function listTransitclass($optParams = array())
    {
        $params = array();
        $params = array_merge($params, $optParams);
        return $this->call('list', array($params), TransitClassListResponse::class);
    }
     ...
     * @throws Exception
     */
    public function patch(string $resourceId, TransitClassCollection $postBody, $optParams = array())
    {
        $params = array('resourceId' => $resourceId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('patch', array($params), TransitClassCollection::class);
    }
     ...
     * @throws Exception
     */
    public function update(string $resourceId, TransitClassCollection $postBody, $optParams = array())
    {
        $params = array('resourceId' => $resourceId, 'postBody' => $postBody);
        $params = array_merge($params, $optParams);
        return $this->call('update', array($params), TransitClassCollection::class);
    }
}